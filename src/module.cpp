...
KModule::KModule(Module *module) : module(module) {}
...
//   if (auto *m = any_cast<const Module *>(&WrappedIr))
//     return (*m)->getName().str();
//   if (auto m = any_cast<const Function *>(&WrappedIr))
//     return (*m)->getName().str();
//   if (auto m = any_cast<const Loop *>(&WrappedIr))
//     return (*m)->getName().str();
//   if (auto m = any_cast<const LazyCallGraph::SCC *>(&WrappedIr))
//     return (*m)->getName();
...
//         BeforePassCallback(LlvmSelfProfiler, PassName.c_str(),
//         IrName.c_str());
//       });
...
void KModule::optimize(LLVMRustPassBuilderOptLevel OptLevelRust,
                       LLVMRustOptStage OptStage, bool NoPrepopulatePasses,
                       bool VerifyIR, bool UseThinLTOBuffers,
                       bool MergeFunctions, bool UnrollLoops, bool SLPVectorize,
                       bool LoopVectorize, bool DisableSimplifyLibCalls) {
